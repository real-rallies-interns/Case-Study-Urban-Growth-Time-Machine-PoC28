...
export default function InfoModal({ isOpen, onClose }: InfoModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-[#030712] border border-accent-primary/20 p-8 shadow-[0_0_50px_rgba(56,189,248,0.1)] animate-in zoom-in-95 duration-200">
        <button 
          onClick={onClose}
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {['Next.js 14+', 'FastAPI', 'Tailwind CSS', 'Mapbox GL JS', 'Deck.gl', 'TypeScript'].map(tech => (
            ...
            <div className="p-4 bg-accent-primary/5 border border-accent-primary/10 rounded">
              <p className="text-[10px] font-mono text-accent-primary leading-relaxed">
                ...
                SECURITY_LEVEL: MASTER_PROTOCOL_ACTIVE
              </p>
            </div>
          </div>
